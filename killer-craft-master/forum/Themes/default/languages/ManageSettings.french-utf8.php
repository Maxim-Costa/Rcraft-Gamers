...
$txt['image_proxy_enabled_desc'] = 'Le proxy utilise les images mises entre les tags <b>[img]</b>';
$txt['image_proxy_secret'] = 'Code Secret pour les Images du Proxy';
$txt['image_proxy_secret_desc'] = 'Ce code doit-être unique pour votre Site. Veuillez tenir ce code secret.';
$txt['image_proxy_maxsize'] = 'Taille maximale des fichiers images mis en cache';
$txt['image_proxy_maxsize_postinput'] = 'Ko';
$txt['image_proxy_maxsize_desc'] = 'Les images plus grandes que cette limite seront encore affichées.';
