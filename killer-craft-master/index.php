                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                ?>
                                Minecraft.php?id=<?php echo $userinfo['id'] ?>
                                <?php
                                 }else{
                                ?>
                                Minecraft.php
                                ...
                                ?>" class="dropdown-toggle" data-toggle="dropdown">Minecraft </a>
                            </li>
                            </li>
                            <li class="dropdown">
                                ...
                                <a href="article.php?id=<?= $a['id'] ?>">
                                    <div class="card card-background" style="background:url('miniatures/<?php echo $a['id'] ?>.jpg') center center / cover">
                                        <div class="image" style="background-image: url(&quot;miniatures/<?php echo $a['id'] ?>.jpg&quot;); background-position: center center; background-size: cover;">
                                            ...
                                            <img src="miniatures/<?php echo $a['id'] ?>.jpg" alt="Team beta testeur - Rcraft-Gamers.tk" style="display: none;">
                                        </div>
                                        <div class="content">
                                            <h5 class="price">
